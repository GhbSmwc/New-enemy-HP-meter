...
;you are free to submit an update to this ASM reousce with this file updated.
;
;This is from pixi version 1.42.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Sub_Off_Screen_XA
...
?.check_sub_off
    ...
    AND #$01
    ;BNE ?.vert_level       ;>branch out of bounds due to 4 bytes between here and destination
    BEQ ?.horiz_level
    JMP ?.vert_level
...
?.kill    
    ...
    JSL !SharedSub_HideHPMeterIfSpriteDespawns ;>Immidiately hide the HP meter (prevent sprite despawn, new sprite spawns on same slot, at the same frame, and HP meter transfers).
?.return
    PLB
    RTL                     ; return
